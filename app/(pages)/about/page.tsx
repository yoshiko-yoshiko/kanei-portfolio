      ...
      <main className="pt-20 pb-16 px-6">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-foreground/60">Fullstack Engineer</p>
          </div>
            ...
            <div className="space-y-6">
              <div className="pl-4 border-l-2 border-primary">
                <div className="flex justify-between items-start mb-1">
                  ...
                  <span className="text-xs text-foreground/40">2025.8 - Present</span>
                </div>
                <p className="text-sm text-foreground/60 mb-2">医療系Webアプリ開発</p>
                <p className="text-xs text-foreground/50">React + NestJS でフロント・バックエンド両方を担当</p>
              </div>

              <div className="pl-4 border-l-2 border-foreground/20">
                <div className="flex justify-between items-start mb-1">
                  <h3 className="font-semibold text-foreground">新卒技術研修 講師リーダー</h3>
                  <span className="text-xs text-foreground/40">2025.5 - 2025.8</span>
                </div>
                <p className="text-sm text-foreground/60 mb-2">約50名の新卒エンジニア育成</p>
                <p className="text-xs text-foreground/50">離脱者ゼロで全員デプロイ完了</p>
              </div>

              <div className="pl-4 border-l-2 border-foreground/20">
                <div className="flex justify-between items-start mb-1">
                  <h3 className="font-semibold text-foreground">システム設計・ヘルプデスク</h3>
                  <span className="text-xs text-foreground/40">2024.6 - 2025.5</span>
                </div>
                <p className="text-sm text-foreground/60 mb-2">電子カルテシステム</p>
                <p className="text-xs text-foreground/50">DynamoDB設計、API仕様書作成、病院向けサポート</p>
              </div>

              <div className="pl-4 border-l-2 border-foreground/20">
                <div className="flex justify-between items-start mb-1">
                  <h3 className="font-semibold text-foreground">学生エンジニア</h3>
                  <span className="text-xs text-foreground/40">2023 - 2024</span>
                </div>
                <p className="text-sm text-foreground/60 mb-2">地域企業紹介サービス開発</p>
                <p className="text-xs text-foreground/50">Next.js フロントエンド開発（10名チーム）</p>
              </div>
            </div>
          </div>
          ...
          {/* Strengths */}
          <div className="mt-12">
            <h2 className="text-xl font-semibold text-foreground mb-6">Strengths</h2>
